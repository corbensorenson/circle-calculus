...
real_phase_formal_precursors=AIRA-T0029,AIRA-T0030 (unwrapped only; not a circular-margin proof)
...
`real_phase_formal_precursors=AIRA-T0029,AIRA-T0030` means Lean has proved the unwrapped one-channel real phase-gap arithmetic used by later real-margin work. It is not a circular modulo-full-turn proof and does not certify the numerical scan.
