...
real_phase_formal_precursors=AIRA-T0029,AIRA-T0030,AIRA-T0031,AIRA-T0032,AIRA-T0033,AIRA-T0037,AIRA-T0038,AIRA-T0039,AIRA-T0040 (unwrapped, signed full-turn, turn-separation, and bank-level no-near-turn precursors only; not a Diophantine proof)
...
`real_phase_formal_precursors=AIRA-T0029,AIRA-T0030,AIRA-T0031,AIRA-T0032,AIRA-T0033,AIRA-T0037,AIRA-T0038,AIRA-T0039,AIRA-T0040` means Lean has proved the unwrapped one-channel real phase-gap arithmetic, signed full-turn-multiple window precursors, and the bank-level theorem shape that one proved separating channel rules out an all-channel near-turn collision at smaller tolerance. It is not a Diophantine proof that arbitrary RoPE gaps satisfy the window hypotheses and does not certify the numerical scan.
