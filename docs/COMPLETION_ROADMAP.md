...
- [x] `papers/applications/PAPER_AI_02_COIL_ATTENTION_AND_MEMORY.md`
  ...
  - Update: `AIT-T0139` through `AIT-T0142` make the public `4096` no-wrap and `8192` coprime planner rows row-specific: the covered/uncovered positive-lag counts are exactly `44`/`4051` and `96`/`8095`.
