...
- Scaling/factor refinements beyond `CC-T0045`: arbitrary target-node fibers outside the image, composite orbit refinements, and factor-lattice/provenance links.
