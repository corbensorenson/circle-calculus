...
- Scaling/factor refinements beyond `CC-T0044`: additive subgroup packaging, arbitrary target-node fibers outside the image, composite orbit refinements, and factor-lattice/provenance links.
