...
- [x] `AIM-B0011`: loop-exit certificate fixture with score trace, exit availability, budget status, overthinking guardrail status, and a fixed-budget no-exit control.
