...
- [x] `papers/applications/PAPER_AI_02_COIL_ATTENTION_AND_MEMORY.md`
  ...
  - Update: `AIT-T0139` through `AIT-T0144` make the public `4096` no-wrap and `8192` coprime planner rows row-specific: the covered/uncovered positive-lag counts are exactly `44`/`4051` and `96`/`8095`, and every query index has exactly `44` or `96` deduplicated predecessor candidates.
