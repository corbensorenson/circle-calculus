...
- [x] `papers/applications/PAPER_AI_02_COIL_ATTENTION_AND_MEMORY.md`
  ...
  - Update: `AIT-T0139` and `AIT-T0140` make the public `4096` no-wrap planner row row-specific: the covered positive-lag count is exactly `44`, and the uncovered positive-lag count is exactly `4051`.
