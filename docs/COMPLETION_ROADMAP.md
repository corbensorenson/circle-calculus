...
- [x] `papers/S1/PAPER_S1_04_FACTORS_SCALING_PRIME_COILS.md`
  ...
  - Status: scaling invertible iff coprime, scale-by-one identity, scaling composition, scaling transport of rotation stride, and scaling transport of finite coil steps are Lean-proved as `CC-T0008`, `CC-T0017`, `CC-T0018`, `CC-T0019`, and `CC-T0020`; deeper factor/orbit refinements remain future extensions.
...
- Scaling/factor refinements beyond `CC-T0020`: factor structure and prime/full-coil refinements.
