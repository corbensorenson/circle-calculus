...
- [x] `papers/applications/PAPER_AI_02_COIL_ATTENTION_AND_MEMORY.md`
  ...
  - Added fixture: `AIM-B0012` is an exploratory learned token-level recurrence fixture with a phase-to-budget lookup, fixed-budget baseline, wrong-period control, shifted-budget control, over-loop control, and nonperiodic scalar-threshold control.
...
- [ ] Learned middle-block recurrence, multi-resolution recurrence, and training-free loop-wrapper prototypes against ordinary looped and nonlooped transformer baselines.
