...
- Scaling/factor refinements beyond `CC-T0037`: full map-image/cardinality packaging, kernel/fiber cardinality, composite orbit refinements, and factor-lattice/provenance links.
