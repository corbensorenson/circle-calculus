...
The generated-proof route now compiles for D15 32k, D16 64k, and D17 128k by emitting compact band-list coverage and rational endpoint-validity facts that feed `AIRA-T0139` through `AIRA-T0141`. The remaining proof-engineering target is sharper channel-wise certificates, full-bank standard-RoPE transfer, proof-build compression, or a continued-fraction bridge.
