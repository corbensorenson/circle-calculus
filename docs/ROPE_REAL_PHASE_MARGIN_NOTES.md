...
The real-phase theorem spine currently runs from `AIRA-T0029` through `AIRA-T0033`, then `AIRA-T0037` through `AIRA-T0045`, plus `AIRA-T0047`, `AIRA-T0050`, and `AIRA-T0053` through `AIRA-T0094`.
...
28. Scale the interval route by converting sharper generated exact rational bands into Lean declarations, then continue toward larger contexts such as 4096 using sharper `π` or continued-fraction bounds.
...
- The current strongest standard channel-0 interval seed is theorem-backed for context 710 only. Larger standard-RoPE contexts need generated rational interval data and sharper `π` or continued-fraction bounds.
