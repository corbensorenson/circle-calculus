...
The Python sidecar still emits exact-rational interval plans for audit and future work. The four-decimal `π` plan through context `333`, the six-decimal `π` plan through context `710`, the 20-decimal context-4096 plans through margin `1/104219`, the 20-decimal context-8192 plans at margins `1/104220` and `1/104219`, and the 20-decimal context-16384 plan at margin `1/104219` have now been converted into Lean declarations. The planner also covers 32k and 64k at margin `1/104219` and reaches first uncovered gap `103993` for a 128k request; these are deterministic source data only until matching declarations compile and manifest ids are marked proved.
