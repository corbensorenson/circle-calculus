...
The real-phase theorem spine currently runs from `AIRA-T0029` through `AIRA-T0033`, then `AIRA-T0037` through `AIRA-T0045`, plus `AIRA-T0047`, `AIRA-T0050`, and `AIRA-T0053` through `AIRA-T0096`.
...
27. Use `AIRA-T0090` through `AIRA-T0094` as the current strongest standard-channel seed: channel 0, `alpha = 1 / (2π)`, context `710`, margin `1/1024`, with generated d6 bands covering gaps `1` through `709` in cells `0` through `112`.
...
29. Scale the interval route by lowering the advertised margin, converting sharper generated exact rational bands into Lean declarations, or adding continued-fraction machinery; do not claim that the current `1/1024` channel-0 margin extends past gap `710`.
...
- The current strongest standard channel-0 interval seed is theorem-backed for context 710 only, and the same `1/1024` margin is theorem-blocked beyond gap 710. Larger standard-RoPE contexts need smaller advertised margins, generated rational interval data, sharper `π`, or continued-fraction bounds.
