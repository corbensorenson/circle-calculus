...
6. Move `circle_mixer_router_head_attachment_v1` candidates into the actual Octopus route/ranker training path and measure heldout quality, runtime, memory, and failure cases against the current router head.
