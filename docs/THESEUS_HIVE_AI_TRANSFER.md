...
6. Extend the actual Octopus router-head `--circle-mixer` trainer path with harder contrastive routing traces, runtime/memory timing, and failure-case tables against the current no-mixer head.
