...
The scored benchmark layer currently implements nine ids:
...
7. Attach `circle_seed_rule_source_change_stress_v1` to repeated workflow/tool-card rebuilds and measure human edit time, automated verifier residuals, and downstream agent reuse across real Theseus-Hive update cycles.
