...
- Outputs: structured lag sample, nonstructured control lag sample, inspected target and candidate list, stride-family/single-stride/local/wrong-family/full rows, structured hit rates, control hit rates, average candidate counts, deduplicated and raw budget upper bounds, theorem links, and dictionary links.
- Theorem ids: `AIT-T0015` through `AIT-T0042`.
