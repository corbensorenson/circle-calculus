...
- Outputs: generated portfolio-route readiness, generated route reviewer-dossier readiness, generated route impact-summary readiness, generated portfolio backing status, generated parity/value comparison status, role-backed value-proposition status, advertising-language guardrail status, portfolio roles, proof provenance coverage, unique and total evidence counts, route audience/claim/boundary rows, route backing rows, route dossier-section rows, route “why this matters” evidence summaries, capability lane, area, paper count, theorem count, executable count, Living Book page count, Living Book widget count, and the explicit claim boundary.
...
- Validation: `scripts/check_capability_showcase.py` requires the matrix mount and script import on the public showcase page; `scripts/site/check_capability_contracts.py` recomputes portfolio route contracts, route reviewer-dossier contracts, route impact-summary contracts, parity/value comparison contracts, role-backed value-proposition contracts, advertising-language guardrail contracts, portfolio counts, and backing totals from generated capability rows; `scripts/site/check_site_widget_contracts.py` verifies the widget index, page mount, and JavaScript mount call.

### capability_audit_checklist

- Inputs: none; the widget reads `site/data/generated/capability_showcase.json`.
- Outputs: generated portfolio backing status, capability lane, generated claim-contract readiness, claim-contract gate count, ordered proof-trail status, role-backed value-proposition status, generated parity/value comparison status, advertising-language guardrail status, proof provenance text, advertised claim, paper/theorem/dictionary/executable/source/Living Book evidence counts, linked paper/theorem/dictionary id lists, proved paper-carried theorem-id counts with Lean names and cited-paper carriers, linked pytest executable refs, linked source refs, paper-backed source-ref counts with Source Trail vs Lean-sidecar-import backing labels, generated reproduction commands, linked Living Book page refs, backed Living Book page/widget presentation counts, Living Book widget ids, and explicit claim boundary.
- Data source: `manifests/capability_showcase.yaml`, exported by `scripts/site/export_site_data.py`.
...
- Validation: `scripts/check_capability_showcase.py` requires every advertised theorem id to be proved and carried by a cited paper, every advertised source ref to be backed by a cited paper Source Trail or cited Lean sidecar import closure, and every Living Book ref to carry the capability reference plus declared widgets or theorem cards; `scripts/site/export_site_data.py` emits matching `theorem_ref_contract`, `source_ref_contract`, `living_book_ref_contract`, `claim_language_contract`, `value_proposition_contract`, `proof_trail_contract`, `review_packet_contract`, `parity_value_comparison_contract`, route `route_contract`, route `route_review_dossier_contract`, route `route_impact_summary_contract`, and portfolio `backing_contract_summary` records; `scripts/site/check_capability_contracts.py` requires every generated claim contract to be ready, every reproduction recipe to match its executable refs, every emitted theorem-ref contract to match the advertised theorem ids, every emitted source-ref contract to match the advertised source refs, every emitted Living Book contract to match the advertised page/widget refs, every value-proposition role to be backed by the evidence required for that role, every ordered proof trail to pass from papers through theorem/source/example/Living Book/guardrail steps, every skeptical-reader review packet to include claim/scope/boundary, paper, theorem, source, executable-command, Living Book, and local verification sections, every parity/value comparison to tie standard reference, Circle expression, Circle-native value, proof backing, review entry, and boundary to generated evidence, every route reviewer dossier to include route scope/boundary, capability packet coverage, standard-parity surface, Circle-native surface, proof provenance, route-wide executable command, and advertising guardrails, every route impact summary to tie audience, standard-math interest, Circle-native value, proof-backed counts, review path, and boundary to generated evidence, every advertising-language contract to avoid unsupported overclaim patterns and include an explicit boundary, every portfolio route to aggregate only ready known capabilities, and every portfolio summary count to match the generated capability rows; `scripts/site/check_site_widget_contracts.py` verifies the widget index, page mount, and JavaScript mount call; `scripts/site/check_site_navigation_contract.py` keeps the verification-page audit route present.
...
- Theorem ids: finite circle, finite-circle exact membership/no-duplicate/nonempty, finite coil/orbit, finite physics-loop, proof-glyph, generator-regeneration, generated-list length, and generator-comparison theorem ids exposed by the selected record.
...
- Theorem ids: `GEN-T0001`, `GEN-T0005`, `GEN-T0017`, `GEN-T0018`, `GEN-T0019`, `GEN-T0020`, `GEN-T0022`, `GEN-T0023`, `GEN-T0024`, `GEN-T0025`, `GEN-T0026`, `GEN-T0027`, `GEN-T0028`, `GEN-T0029`, `GEN-T0030`, `GEN-T0031`, `GEN-T0032`, `GEN-T0033`, `GEN-T0034`, `GEN-T0035`, `GEN-T0036`, `GEN-T0037`, `GEN-T0038`, `GEN-T0039`, `GEN-T0040`, `GEN-T0041`, `GEN-T0042`, `GEN-T0043`, `GEN-T0044`, `GEN-T0045`, `GEN-T0046`, `GEN-T0047`, `GEN-T0048`, `GEN-T0049`, and `GEN-T0050`.
...
- Outputs: per-token recurrence-budget strip, selected middle-block record, coarse/fine resolution labels, active-token counts by loop step, inactive-token count accounting, first-step/beyond-period active-step boundary, monotone-work and duplicate-free schedule checks, one-step and arbitrary-extra post-period active-work extension checks, fixed-budget control, wrong-budget control, over-loop control, nonperiodic phase-lookup control, and scalar-threshold control.
- Theorem ids: `AIM-T0006`, `AIM-T0007`, `AIM-T0008`, `AIM-T0009`, `AIM-T0018`, `AIM-T0022`, `AIM-T0026`, `AIM-T0027`, `AIM-T0035`, `AIM-T0036`, `AIM-T0037`, `AIM-T0038`, `AIM-T0106`, `AIM-T0111`, `AIM-T0112`, `AIM-T0113`, `AIM-T0114`, `AIM-T0115`, `AIM-T0116`, `AIM-T0120` through `AIM-T0129`, `AIM-T0130`, `AIM-T0131`, `AIM-T0138`, `AIM-T0139`, `AIM-T0144`, `AIM-T0145`, and `AIM-T0150` through `AIM-T0159` as finite loop-budget, active-step, active-token-list boundary, monotone-work, duplicate-free, count-bound, active/inactive accounting, saved-work accounting, post-period extension, and public work-count fixture primitives.
...
- Theorem ids: `AIM-T0006`, `AIM-T0007`, `AIM-T0008`, `AIM-T0009`, `AIM-T0018`, `AIM-T0022`, and `AIM-T0057` as finite loop-budget primitives.
- Dictionary ids: `COMMON-0052`, `COMMON-0053`, `COMMON-0059`, `COMMON-0068`, and `COMMON-0069`.
...
- Theorem ids: `AIM-T0006`, `AIM-T0007`, `AIM-T0008`, `AIM-T0009`, `AIM-T0018`, `AIM-T0039`, `AIM-T0040`, `AIM-T0041`, `AIM-T0042`, `AIM-T0043`, `AIM-T0044`, `AIM-T0045`, `AIM-T0046`, `AIM-T0047`, `AIM-T0048`, and `AIM-T0056` through `AIM-T0058` as finite loop-budget, selected middle-block route, and combined route/budget common-cycle/initialization primitives.
...
Companion non-widget prototype: `AIM-B0015` uses `circle_math.applications.circle_ai.run_tiny_looped_recurrent_prototype` with theorem ids `AIM-T0049` through `AIM-T0055`. It records certified-budget state reads, positive raw-budget closure, state-to-label lookup, one-step, scalar, wrong-period, and nonperiodic controls. It is documented in the AI chapter and parity-checked in `scripts/site/check_widget_python_parity.py`, but it is not a browser widget yet.
...
- Inputs: cache size, current token, inspected token, optional batch tokens, and optional sink-prefix size.
- Outputs: selected token slot, current slot, retained-window status, next same-slot overwrite, overwrite-after-current flag, stale-by-overwrite-boundary flag, stale same-slot overwrite witness flag, stale iff later same-slot-write trace flag, retained iff no-later-same-slot-write trace flag, trace-fresh iff next-overwrite-boundary flag, stale requested-member count, stale count zero iff no stale member flag, pass iff stale count zero flag, fail iff stale count positive flag, batch next-overwrites-after-current flag, trace-fresh batch slot-distinctness flag, ordered live-window subrequest flag, duplicate-free live-window subrequest flag, live-window subrequest pass-contract flag, modeled adapter request-trace pass/fail status, adapter pass iff boundary flag, current-slot collision flag, retained-older-token distinctness flag, live-window token list, live-window slot list, optional sink-prefix token list, filtered rolling-suffix tokens, sink-window exact-policy flag, sink-window token-distinct flag, sink-window token-count bound flag, sink-window disjoint exact-count flag, sink-prefix disjoint-from-live-window flag, retained rolling-suffix flag, pinned sink-prefix policy-retention flag, pinned sink-prefix outside ordinary rolling-window flag, theorem-status badges, and dictionary links.
- Theorem ids: `AIM-T0059` through `AIM-T0083`, `AIM-T0086` through `AIM-T0089`, `AIM-T0091` through `AIM-T0105`, `AIM-T0108` through `AIM-T0110`, `AIM-T0117` through `AIM-T0119`, `AIM-T0136`, `AIM-T0137`, `AIM-T0148`, and `AIM-T0149`.
- Dictionary ids: `COMMON-0028`, `COMMON-0081`, and `COMMON-0090`.
- Python references: `circle_math.applications.circle_ai.kv_cache_slot`, `circle_math.applications.circle_ai.kv_cache_window_contains`, `circle_math.applications.circle_ai.kv_cache_next_overwrite_token`, `circle_math.applications.circle_ai.kv_cache_next_overwrite_after_current`, `circle_math.applications.circle_ai.kv_cache_same_slot_overwrite_witness_when_stale`, `circle_math.applications.circle_ai.kv_cache_stale_iff_same_slot_overwrite_trace`, `circle_math.applications.circle_ai.kv_cache_stale_requested_count`, `circle_math.applications.circle_ai.kv_cache_stale_requested_count_zero_iff_no_stale_member`, `circle_math.applications.circle_ai.kv_cache_retained_iff_no_same_slot_overwrite_trace`, `circle_math.applications.circle_ai.kv_cache_trace_fresh_iff_next_overwrite_boundary`, `circle_math.applications.circle_ai.kv_cache_batch_retained_iff_no_same_slot_overwrite_trace`, `circle_math.applications.circle_ai.kv_cache_batch_trace_fresh_iff_next_overwrite_boundary`, `circle_math.applications.circle_ai.kv_cache_trace_fresh_batch_slots_distinct`, `circle_math.applications.circle_ai.kv_cache_ordered_live_window_subrequest`, `circle_math.applications.circle_ai.certify_kv_cache_window`, `circle_math.applications.circle_ai.certify_kv_cache_batch`, and `circle_math.applications.circle_ai.certify_kv_cache_adapter_request_trace`.
...
- Outputs: structured lag sample, nonstructured control lag sample, inspected target and candidate list, stride-family/single-stride/local/wrong-family/full rows, structured hit rates, control hit rates, average candidate counts, covered/uncovered lag counts, uncovered-lag interval summary, theorem-side lag and query-candidate counts, candidate-range unique-count iff and count-formula flags, no-wrap separated and no-zero-residue candidate-range sufficient-condition statuses, period-threshold fields, per-stride zero-residue alias-count fields, family-total zero-residue alias-count fields, coil-residue no-collision, local/coil disjointness, predecessor-map injectivity, `window < context` predecessor-injectivity sufficient-condition status, no-collision flags, deduplicated and raw budget upper bounds, raw-budget plus unique-lag and unique-query shortfall/gap guards, lag/query dedup-loss fields, lag/query collision-pair count, pair-count boundary fields, pair-count severity fields, first-gap/first-interval repair fields, and complete-repair minimality fields, theorem links, and dictionary links.
- Theorem ids: `AIT-T0015` through `AIT-T0170`.
- Dictionary ids: `COMMON-0075`, `COMMON-0079`, `COMMON-0047`, and `COMMON-0029`.
- Python references: `circle_math.applications.circle_ai.stride_family_attention_candidates`, `circle_math.applications.circle_ai.stride_family_lag_candidate_list`, `circle_math.applications.circle_ai.stride_family_query_candidate_list`, `circle_math.applications.circle_ai.consecutive_integer_intervals`, `circle_math.applications.circle_ai.stride_family_no_wrap_separated_sufficient_condition`, `circle_math.applications.circle_ai.structured_stride_family_target_lags`, `circle_math.applications.circle_ai.nonstructured_stride_family_control_lags`, and `circle_math.applications.circle_ai.run_stride_family_sparse_attention_benchmark`.
...
- Validation: deterministic JavaScript-equivalent period-estimation, period-discretization, capped-LCM, bounded prefix, and certificate-field formulas are parity-checked against the Python certifier.
...
- Theorem ids: `PHYS-T0004`, `PHYS-T0005`, `PHYS-T0046`, `PHYS-T0047`, `PHYS-T0049`, `PHYS-T0052`, `PHYS-T0053`, `PHYS-T0054`, `PHYS-T0055`, `PHYS-T0056`, `PHYS-T0057`, `PHYS-T0058`, `PHYS-T0059`, `PHYS-T0060`, `PHYS-T0061`, `PHYS-T0062`, `PHYS-T0063`, and `PHYS-T0064`, linking the sampled Python certificate to the Lean-proved closed-loop identity, two-path cycle invariance, gauge-sample independence, two-path basepoint-swap, three-path cycle, and complete cyclic three-path basepoint-rotation boundaries.
- Dictionary ids: `COMMON-0060`, `COMMON-0061`, `COMMON-0062`, and `COMMON-0063`.
...
- Validation: deterministic JavaScript-equivalent formulas are parity-checked against the Python Wilson-loop certificate and three-path closed-cycle helpers.
...
- `scripts/site/check_capability_contracts.py` verifies generated proof-backed showcase claim contracts and fails if any advertised capability is missing its standard anchor, Circle expression, Circle-native value, proof provenance, proved paper-carried theorem-ref contract, paper-backed source-ref contract, executable support, generated reproduction recipe, ordered proof-trail contract, skeptical-reader review-packet contract, parity/value comparison contract, role-backed value-proposition contract, advertising-language guardrail, backed Living Book presentation contract, not-claimed boundary, or matching portfolio-level backing summary. It also fails if a parity/value comparison is not backed by generated standard-reference, Circle-expression, Circle-native-value, proof-backing, review-entry, and boundary sections, if a portfolio route aggregates unknown or incomplete capabilities, if a route reviewer dossier is missing route scope, capability packet coverage, standard-parity coverage, Circle-native coverage, proof provenance, route-wide executable command, or advertising guardrails, or if a route impact summary is not backed by generated audience, interest, value, evidence-count, review-path, and boundary sections.
...
- Wilson-loop certificate original holonomy, transformed sampled-gauge holonomies, rotated three-path basepoint holonomies, sampled invariance ids, and theorem id payload.
