...
- Outputs: generated portfolio-route readiness, generated portfolio backing status, advertising-language guardrail status, portfolio roles, proof provenance coverage, unique and total evidence counts, route audience/claim/boundary rows, capability lane, area, paper count, theorem count, executable count, Living Book page count, Living Book widget count, and the explicit claim boundary.
