...
- Theorem ids: `PHYS-T0004`, `PHYS-T0005`, `PHYS-T0046`, `PHYS-T0047`, `PHYS-T0049`, `PHYS-T0052`, `PHYS-T0053`, `PHYS-T0054`, `PHYS-T0055`, `PHYS-T0056`, `PHYS-T0057`, `PHYS-T0058`, `PHYS-T0059`, `PHYS-T0060`, and `PHYS-T0061`, linking the sampled Python certificate to the Lean-proved closed-loop identity, two-path cycle invariance, two-path basepoint-swap, three-path cycle, and one-step/two-step three-path basepoint-rotation boundaries.
- Dictionary ids: `COMMON-0060`, `COMMON-0061`, `COMMON-0062`, and `COMMON-0063`.
