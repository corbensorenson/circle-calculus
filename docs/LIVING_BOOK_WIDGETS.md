...
- Outputs: generated portfolio backing status, portfolio roles, proof provenance coverage, unique and total evidence counts, capability lane, area, paper count, theorem count, executable count, Living Book page count, Living Book widget count, and the explicit claim boundary.
