...
- Outputs: generated portfolio-route readiness, generated portfolio backing status, role-backed value-proposition status, advertising-language guardrail status, portfolio roles, proof provenance coverage, unique and total evidence counts, route audience/claim/boundary rows, capability lane, area, paper count, theorem count, executable count, Living Book page count, Living Book widget count, and the explicit claim boundary.
...
- Theorem ids: `PHYS-T0004`, `PHYS-T0005`, `PHYS-T0046`, `PHYS-T0047`, `PHYS-T0049`, `PHYS-T0052`, `PHYS-T0053`, `PHYS-T0054`, `PHYS-T0055`, `PHYS-T0056`, `PHYS-T0057`, `PHYS-T0058`, and `PHYS-T0059`, linking the sampled Python certificate to the Lean-proved closed-loop identity, two-path cycle invariance, two-path basepoint-swap, three-path cycle, and three-path basepoint-rotation boundaries.
- Dictionary ids: `COMMON-0060`, `COMMON-0061`, `COMMON-0062`, and `COMMON-0063`.
