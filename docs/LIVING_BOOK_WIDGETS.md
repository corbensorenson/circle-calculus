...
- Outputs: generated portfolio-route readiness, generated route reviewer-dossier readiness, generated route impact-summary readiness, generated portfolio backing status, role-backed value-proposition status, advertising-language guardrail status, portfolio roles, proof provenance coverage, unique and total evidence counts, route audience/claim/boundary rows, route backing rows, route dossier-section rows, route “why this matters” evidence summaries, capability lane, area, paper count, theorem count, executable count, Living Book page count, Living Book widget count, and the explicit claim boundary.
...
- Theorem ids: `AIM-T0006`, `AIM-T0007`, `AIM-T0008`, `AIM-T0009`, `AIM-T0018`, `AIM-T0039`, `AIM-T0040`, `AIM-T0041`, `AIM-T0042`, `AIM-T0043`, `AIM-T0044`, `AIM-T0045`, `AIM-T0046`, `AIM-T0047`, and `AIM-T0048` as finite loop-budget, selected middle-block route, and combined route/budget common-cycle primitives.
...
- `scripts/site/check_capability_contracts.py` verifies generated proof-backed showcase claim contracts and fails if any advertised capability is missing its standard anchor, Circle expression, Circle-native value, proof provenance, proved paper-carried theorem-ref contract, paper-backed source-ref contract, executable support, generated reproduction recipe, ordered proof-trail contract, skeptical-reader review-packet contract, role-backed value-proposition contract, advertising-language guardrail, backed Living Book presentation contract, not-claimed boundary, or matching portfolio-level backing summary. It also fails if a portfolio route aggregates unknown or incomplete capabilities, if a route reviewer dossier is missing route scope, capability packet coverage, standard-parity coverage, Circle-native coverage, proof provenance, route-wide executable command, or advertising guardrails, or if a route impact summary is not backed by generated audience, interest, value, evidence-count, review-path, and boundary sections.
