...
- Outputs: structured lag sample, nonstructured control lag sample, inspected target and candidate list, stride-family/single-stride/local/wrong-family/full rows, structured hit rates, control hit rates, average candidate counts, covered/uncovered lag counts, uncovered-lag interval summary, theorem-side lag and query-candidate counts, candidate-range unique-count iff and count-formula flags, coil-residue no-collision, local/coil disjointness, predecessor-map injectivity, `window < context` predecessor-injectivity sufficient-condition status, no-collision flags, deduplicated and raw budget upper bounds, raw-budget and unique-lag shortfall/incompleteness guards, theorem links, and dictionary links.
- Theorem ids: `AIT-T0015` through `AIT-T0114`.
- Dictionary ids: `COMMON-0075`, `COMMON-0079`, `COMMON-0047`, and `COMMON-0029`.
- Python references: `circle_math.applications.circle_ai.stride_family_attention_candidates`, `circle_math.applications.circle_ai.stride_family_lag_candidate_list`, `circle_math.applications.circle_ai.stride_family_query_candidate_list`, `circle_math.applications.circle_ai.consecutive_integer_intervals`, `circle_math.applications.circle_ai.structured_stride_family_target_lags`, `circle_math.applications.circle_ai.nonstructured_stride_family_control_lags`, and `circle_math.applications.circle_ai.run_stride_family_sparse_attention_benchmark`.
