...
```text
AIRA-T0029 through AIRA-T0033, AIRA-T0037 through AIRA-T0040
```
...
- The real-phase Lean work has conditional one-turn-window, turn-separation, and finite bank no-near-turn precursors, not the continued-fraction or Diophantine theorem needed for arbitrary RoPE gaps.
