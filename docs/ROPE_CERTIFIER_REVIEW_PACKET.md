...
```text
AIRA-T0027, AIRA-T0028, AIRA-T0034, AIRA-T0035, AIRA-T0036, AIRA-T0046, AIRA-T0048, AIRA-T0049, AIRA-T0051, AIRA-T0052, AIRA-T0174 through AIRA-T0176, AIRA-T0203 through AIRA-T0207, and AIRA-T0210 through AIRA-T0213
```

Real-phase theorem program and finite-margin certificates:

```text
AIRA-T0029 through AIRA-T0033, AIRA-T0037 through AIRA-T0045, AIRA-T0047, AIRA-T0050, AIRA-T0053 through AIRA-T0173, AIRA-T0208, AIRA-T0209, AIRA-T0214, AIRA-T0215, AIRA-T0222 through AIRA-T0229, and AIRA-T0239 through AIRA-T0241
```
...
- The real-phase Lean work has conditional one-turn-window, turn-separation, finite bank no-near-turn, turn-ratio scaling, one-channel plus bank-level finite-context margin consequence, context-plus-margin transfer, integer/rational-turn-ratio guardrails, generated-gap finite-enumeration, floor/ceiling nearest-integer witness bridge precursors, scalar nearest-gap margins, reusable exact weakest-gap report contracts (`AIRA-T0214`, `AIRA-T0215`), one named theorem-backed rational/discretized `1/4099` context-4096 certificate, reusable rational/discretized exact-gap, full-denominator exact-threshold, and request-obstruction theorems (`AIRA-T0222` through `AIRA-T0229`), a generic rational interval-certificate bridge, interval-certificate margin monotonicity, a generated-band endpoint bridge, standard-RoPE channel-0 seeds for `1 / (2π)`, proved gap-`710` obstructions for margins `1/1024`, `1/65536`, `1/104000`, and every margin at or above `1/104218`, context-`4096`, context-`8192`, context-`16384`, context-`32768`, and context-`65536` channel-0 seeds at margin `1/104219`, plus generated D17 context-`131072`, D18 context-`163840`, and D19 context-`196608` seeds at margin `1/328459`. The D19 range bracket proves every margin at or above `1/328458` impossible for every `103993 < context <= 196608`, while the lower `1/328459` margin holds over that whole range. `AIRA-T0239` adds a Dirichlet finite-context witness: every turn ratio and nontrivial context has some in-context gap with nearest-integer error at most `1/context`; `AIRA-T0240` turns that witness into the direct theorem that no finite-context margin strictly above `1/context` can hold; `AIRA-T0241` applies the same ceiling to exact weakest-gap report margins. The `AIRA-T0139`/`AIRA-T0140`/`AIRA-T0141` rational-band compression and endpoint-reflection bridge now powers generated 32k/64k/128k/160k/192k interval certificates; the generated source stores those large tables as compact uniform gap/cell rows with shared rational bounds attached inside Lean, proves coverage through a contiguous gap-chain bridge instead of a gap-by-band search, and checks endpoint validity on compact rows before reflecting it to expanded band validity.
