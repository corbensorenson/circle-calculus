...
| `llama_style_10000_128k` | exact discrete PASS | the rounded integer-period bank still has its common gap outside context; the real-phase proof layer now separately has a one-channel D18 160k standard-channel certificate |
...
```text
AIRA-T0029 through AIRA-T0033, AIRA-T0037 through AIRA-T0045, AIRA-T0047, AIRA-T0050, AIRA-T0053 through AIRA-T0167
```
