...
```text
AIRA-T0029 through AIRA-T0033, AIRA-T0037, AIRA-T0038
```
...
- The real-phase Lean work has conditional one-turn-window and turn-separation precursors, not the continued-fraction or Diophantine theorem needed for arbitrary RoPE gaps.
