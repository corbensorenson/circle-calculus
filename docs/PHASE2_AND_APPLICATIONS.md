...
- `PAPER_P2_05_PROOF_CARRYING_GLYPHS` proves the proof-glyph certificate projection facts `P2G-T0001` through `P2G-T0003` in Lean through `Circle.Phase2.proofGlyphTheoremId_mk`, `Circle.Phase2.proofGlyphLeanName_mk`, and `Circle.Phase2.proofGlyphGlyphId_mk`, with matching Python examples.
