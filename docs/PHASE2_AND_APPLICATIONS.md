...
- Looped/recursive transformer work starts with `AIM-B0003`, a deterministic recurrence-schedule fixture, and should expand toward dense transformer depth, Universal Transformer recurrence, fixed looped transformers, adaptive early-exit models, recurrent-memory transformers, sparse/MoE looped models, RWKV/Mamba-style recurrent/state-space models, and ordinary nonrecursive transformer baselines before any reasoning-depth, quality, context-length, or parameter-efficiency claim.
