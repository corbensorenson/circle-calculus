...
- Prove a real-phase margin theorem or a bounded precursor for RoPE-style rotations. The landed spine now includes the generated-gap, floor/ceiling, interval-certificate, rational-band compression, and endpoint-reflection route; rational/discretized `1/4099`; genuine standard-RoPE channel-0 seeds through 64k at margin `1/104219`; and a generated D18 160k seed at margin `1/328459` (`AIRA-T0029` through `AIRA-T0033`, `AIRA-T0037` through `AIRA-T0045`, `AIRA-T0047`, `AIRA-T0050`, and `AIRA-T0053` through `AIRA-T0167`). Lean also proves obstruction brackets: gap `710` blocks margins at or above `1/104218` for the sharp 64k family, and gap `103993` blocks margins at or above `1/328458` for the 160k D18 family. The generated proof-build route now stores standard-channel interval bands in a compact uniform form: each generated row records only the gap range and cell, while the shared rational `1/(2*pi)` lower/upper bounds are attached once inside Lean before feeding the existing rational-band proof bridge. It proves generated coverage through a contiguous gap-chain certificate instead of a nested search over every gap and every band, and it checks endpoint validity on the same compact rows before reflecting that audit into expanded band validity. This keeps the Lean proof shape aligned with the Python sidecar audit without changing theorem meanings. The next hard step is a full-bank standard-RoPE theorem, sharper channel-wise certificates, faster native rational endpoint checking, generated-table chunking beyond the current 160k practical build horizon, or a continued-fraction bridge, not a model-quality claim.
