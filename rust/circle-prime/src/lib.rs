...
pub use scalar::{
    ...
    ANGLE_BUNDLE_HORIZON_PRODUCTS, MR64_BASES, PRIME_HORIZON_LEAN_NAMES, PRIME_HORIZON_THEOREM_IDS,
...
pub use segmented::{
    ...
    prime_count_in_range_wheel30_marks, prime_count_in_range_wheel30_marks_parallel, prime_pi_u64,
    primes_in_range, recommended_count_mode, recommended_count_segment_size,
    recommended_segment_size, RangeError, DEFAULT_SEGMENT_SIZE, HIGH_OFFSET_SEGMENT_SIZE,
