...
The theorem cards below are checked by Lean for finite regeneration statements. `GEN-T0003` proves exact regeneration of the representative-indexed orbit-schedule list. `GEN-T0006` through `GEN-T0009` add count, period, coverage, and formal orbit-class agreement facts. They still do not prove optimality, minimality, or full canonical partition structure.
