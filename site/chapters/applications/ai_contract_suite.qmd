...
are `normalized_request`, `evidence`, `proof_status`, `proof_layers`, `support`,
and `not_claimed`. Read the [AI Contract Runner](ai_contract_runner.qmd) lesson
before wiring the JSON into another project.
