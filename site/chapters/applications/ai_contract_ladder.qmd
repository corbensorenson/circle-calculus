...
The conditional bank bridge says that if a finite real-phase bank contains that channel and the inspected context and margin are within the seed, then the all-channel near-turn condition is ruled out under the stated tolerance scaling.
