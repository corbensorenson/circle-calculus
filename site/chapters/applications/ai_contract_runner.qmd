...
model-config import-report path, optional request-validation report path,
optional certification-bundle path, optional receipt path, status, theorem
count, recommendation count, validation-command count, decision verdict,
assurance level, the `normalized_request` parameters, the source-content
fingerprint, and receipt fingerprints for each checked item. Model-config
summaries also inline
