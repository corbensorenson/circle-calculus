...
audit outputs such as standalone request-validation reports, artifact
manifests, pin-policy checks, and whole-directory artifact bundles. Use that
script when a handoff needs the full repository audit trail rather than a
single installed-package receipt or certification bundle.
