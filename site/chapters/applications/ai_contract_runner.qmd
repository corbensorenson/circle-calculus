...
audit outputs such as request-validation reports, certification bundles,
artifact manifests, and pin-policy checks. Use that script when a handoff needs
the full audit bundle rather than a single installed-package receipt.
