...
audit outputs such as request-validation reports, gate reports, receipt checks,
receipt-replay checks, certification bundles, artifact manifests, and pin-policy
checks. Use that script when a handoff needs the full audit bundle rather than a
single installed-package receipt.
