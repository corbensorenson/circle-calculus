...
audit workflows such as artifact-dir default naming, pin-policy checks, and
whole-directory artifact bundles. Use that script when a handoff needs the full
repository audit trail rather than a single installed-package receipt,
certification bundle, or explicit artifact manifest.
