...
The real-phase RoPE program is separate from that exact integer-period contract. It now has theorem-backed finite-margin seeds, including the rational/discretized `1/4099` context-4096 certificate, the standard channel-0 context-4096 interval seed at margin `1/104219`, a standard channel-0 context-8192 seed at margin `1/104220`, and D12 one-separating-channel bank bridges (`AIRA-T0060` through `AIRA-T0125`). The bracket theorems package the channel-0 result as: `1/104219` is proved at 4k, `1/104220` is proved at 8k, and any margin at or above `1/104218` is impossible for either context. These are one-channel or conditional bank-level real-phase certificates, not a full 128k standard-RoPE bank theorem.
