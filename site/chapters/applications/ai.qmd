...
The real-phase RoPE program is separate from that exact integer-period contract. It now has theorem-backed finite-margin seeds, including the rational/discretized `1/4099` context-4096 certificate, the standard channel-0 context-4096 interval seed at margin `1/104219`, and a standard channel-0 context-8192 seed at margin `1/104220` (`AIRA-T0060` through `AIRA-T0122`). The bracket theorem packages the 4k channel-0 result as: `1/104219` is proved, while any margin at or above `1/104218` is impossible. These are one-channel or conditional bank-level real-phase certificates, not a full 128k standard-RoPE bank theorem.
