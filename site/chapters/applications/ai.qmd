...
The real-phase RoPE program is separate from that exact integer-period contract. It now has theorem-backed finite-margin seeds, including the rational/discretized `1/4099` context-4096 certificate and the standard channel-0 context-4096 interval seed at margin `1/105000` (`AIRA-T0060` through `AIRA-T0110`). Those are one-channel or conditional bank-level real-phase certificates, not a full 128k standard-RoPE bank theorem.
