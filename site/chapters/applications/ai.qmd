...
- a finite family of admitted coil strides has exact reach/miss conditions, local-window thresholds, complete-coverage iff no positive uncovered-lag witness, raw and clipped candidate-budget bounds, theorem-side candidate-list semantics, no-duplicate budget-survival criteria, finite positive-lag coverage iff, finite uncovered-list iffs, and concrete default-plan gap witnesses (`AIT-T0015` through `AIT-T0084`).
