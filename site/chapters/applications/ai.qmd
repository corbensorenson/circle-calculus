...
The generic AI contract pack exposes two planner-facing records for this
fixture. `MEMORY-ATTACH-WINDING-ALIAS-PROVENANCE` tells a consumer to keep
winding/provenance beside same-slot aliases, and
`MEMORY-AUDIT-FINITE-ALIAS-LOAD` reports finite slot-load pressure for the
declared trace. They are audit records for residue/winding bookkeeping, not
retrieval, memory capacity, allocation-policy, throughput, or model-quality
claims.
