...
D19 is the current proved standard-channel frontier. The D19 bridge turns that channel-0 seed into a conditional one-separating-channel bank certificate when standard channel 0 is present. `AIRA-T0173` packages the 192k endpoint bracket, and `AIRA-T0208` packages the range bracket: `1/328459` is proved for every requested context with `103993 < context <= 196608`, while every margin at or above `1/328458` is impossible throughout that range. This is still not a full all-channel margin theorem.
