...
For the shortest current findings summary, read the [RoPE Certifier Results Note](https://github.com/corbensorenson/circle-calculus/blob/main/docs/ROPE_CERTIFIER_RESULTS_NOTE.md). It is the compact bridge between the preset table, the D19 one-channel real-phase frontier, the reproduction commands, and the non-claims.
...
`AIRA-T0234` through `AIRA-T0240` theorem ids:
