...
Prime-size finite circles also touch classical additive combinatorics. These cards are external theorem bridges imported through mathlib: they show that `C n` is the right finite cyclic object for zero-sum and sumset-growth statements, but they are not new Circle Calculus proofs.
