...
If you are here specifically for proof-carrying AI contracts, start with the [AI contract ladder](chapters/applications/ai_contract_ladder.qmd), then open the [RoPE certifier](chapters/applications/rope_certifier.qmd). That path shows the flagship position-distinguishability contract first, then points to the exact Python CLI, Lean declarations, theorem ids, paper trail, and limitations.
