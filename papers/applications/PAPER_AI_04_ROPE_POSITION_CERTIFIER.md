...
The sidecar also emits exact-rational interval plans for audit and standard-channel interval certificates. The four-decimal context-333 plan, six-decimal context-710 plan, 20-decimal context-4096 plans through the `1/104219` 4k seed, the 20-decimal context-8192 plans at margins `1/104220` and `1/104219`, and the 20-decimal context-16384 plan at margin `1/104219` are matched by Lean declarations. The generated Markdown and JSON include `Band Endpoint Audit` summaries sampling the first and last band of each standard interval plan; rerun the Python planner for the complete deterministic band list. Larger generated plans remain reproducible source data until matching Lean declarations compile and manifest ids are marked proved.
