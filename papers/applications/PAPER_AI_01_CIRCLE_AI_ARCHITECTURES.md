...
- Use the private Theseus-Hive consumers for `site/data/generated/theseus_hive_ai_contracts.json` as the report boundary, keeping private reports out of the public Circle repository unless they are intentionally scrubbed and public-safe; next promote the six aggregate attachments into scored private recurrence, fanout, memory, phase-feature, mixer, and seed-rule benchmarks.
