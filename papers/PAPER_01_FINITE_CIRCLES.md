...
- Theorem ids proved in Lean: `CC-T0001`, `CC-T0002`, `CC-T0003`, `CC-T0004`, `CC-T0005`, `CC-T0006`, `CC-T0007`, `CC-T0054`, `CC-T0055`
...
`CC-T0055` exposes the same quotient boundary as a membership theorem: two nodes are in the same stride-orbit quotient exactly when their difference lies in the additive subgroup generated by the stride. The later gcd representative theorem should build from this quotient-level API rather than from an informal natural-number difference.
