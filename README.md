...
| `papers/S1/PAPER_S1_04_FACTORS_SCALING_PRIME_COILS.md` | draft | `CC-T0008`, `CC-T0017`, and `CC-T0018` proved |
...
The theorem manifest also includes `CC-T0008`, `CC-T0017`, and `CC-T0018`, proving the first scaling spine: invertibility iff coprime, scale-by-one identity, and scaling composition.
