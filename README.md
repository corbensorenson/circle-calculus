...
| `papers/applications/PAPER_AI_02_COIL_ATTENTION_AND_MEMORY.md` | polished draft/proved finite seed | `AIM-T0001` through `AIM-T0005` are Lean-proved cyclic-memory-slot facts with Python examples; `AIM-B0001` adds an exploratory cyclic-memory fixture, `AIM-B0002` adds an exploratory coil-retrieval reachability fixture, and `COMMON-0052` through `COMMON-0054` add planned looped/recursive transformer recurrence-schedule vocabulary |
| `papers/applications/PAPER_AI_03_COILRA_AND_MULTICOIL_ROPE.md` | polished draft/proved finite seed | `AIRA-T0001` through `AIRA-T0005` are Lean-proved adapter-block facts with Python examples; `AIRA-B0001` adds an exploratory adapter-block fixture, `AIRA-B0002` adds an exploratory MultiCoil/RoPE-style positional fixture, and `AIRA-B0003` adds an exploratory RoPE-style relative phase fixture |
