...
| `papers/S1/PAPER_S1_04_FACTORS_SCALING_PRIME_COILS.md` | draft | `CC-T0008`, `CC-T0017`, `CC-T0018`, `CC-T0019`, `CC-T0020`, `CC-T0021`, `CC-T0022`, `CC-T0023`, and `CC-T0024` proved |
...
The theorem manifest also includes `CC-T0008`, `CC-T0017`, `CC-T0018`, `CC-T0019`, `CC-T0020`, `CC-T0021`, `CC-T0022`, `CC-T0023`, and `CC-T0024`, proving the first scaling spine: invertibility iff coprime, scale-by-one identity, scaling composition, scaling transport of rotation stride, scaling transport of finite coil steps, bijectivity of nonzero scaling on prime circles, divisor-cofactor collapse to zero, cofactor-multiple collapse to zero, and cofactor-shift address collapse.
