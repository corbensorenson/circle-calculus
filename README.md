...
- `AIM-T0044` through `AIM-T0048`: Lean-proved combined middle-block/budget route lower/upper block bounds, positive/bounded budget facts, and product common-cycle closure
- `AIM-T0049` through `AIM-T0053`: Lean-proved looped recurrent-state boundedness, one-step zero state, required-depth phase recovery, certified-budget phase recovery, and whole-period token-shift invariance facts
...
- `PHYS-T0056` through `PHYS-T0059`: Lean-proved three-path closed-cycle holonomy, gauge-shifted holonomy, basepoint-rotation holonomy, and basepoint-rotation gauge-shifted holonomy theorems
