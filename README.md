...
- `PHYS-T0056` through `PHYS-T0061`: Lean-proved three-path closed-cycle holonomy, gauge-shifted holonomy, one-step basepoint-rotation, and two-step basepoint-rotation theorems
