...
- `AIM-T0044` through `AIM-T0048` plus `AIM-T0056` through `AIM-T0058`: Lean-proved combined middle-block/budget route lower/upper block bounds, positive/bounded budget facts, one-cycle/multi-cycle product common-cycle closure, token-budget zero anchor, and combined route/budget zero anchor
...
- `GEN-T0044` and `GEN-T0045`: Lean-proved bounded-generator-search count guardrails
