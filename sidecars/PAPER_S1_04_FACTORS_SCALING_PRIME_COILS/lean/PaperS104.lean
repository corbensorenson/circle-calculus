...
#check Circle.rot_bijective
#check Circle.scale
#check Circle.affineMap
...
#check Circle.scaleFiberRepresentativeSet_zero_eq_scaleKernelRepresentativeSet
#check Circle.scaleFiberRepresentativeSet_eq_iff_scaled_eq_of_lt
#check Circle.scaleFiberRepresentativeSet_eq_iff_period_modEq_of_lt
#check Circle.scaleTargetFiberRepresentativeSet
#check Circle.scaleTargetFiberRepresentativeSet_scaled_eq_scaleFiberRepresentativeSet
...
#check Circle.affineMap_comp
#check Circle.affineMap_bijective_of_coprime
