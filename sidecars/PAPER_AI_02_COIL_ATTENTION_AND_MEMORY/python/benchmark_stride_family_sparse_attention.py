...
def main() -> None:
    ...
    print(
        ...
        f"coil_residues_no_collision="
        f"{result.coverage_certificate.theorem_side_coil_residues_no_collision} "
        f"local_coil_disjoint={result.coverage_certificate.theorem_side_local_coil_disjoint} "
        f"lag_candidates_no_collision="
        f"{result.coverage_certificate.theorem_side_lag_candidates_no_collision} "
        f"predecessor_injective_on_lag_candidates="
        f"{result.coverage_certificate.theorem_side_predecessor_injective_on_lag_candidates} "
        f"query_candidates_no_collision="
        f"{result.coverage_certificate.theorem_side_query_candidates_no_collision} "
