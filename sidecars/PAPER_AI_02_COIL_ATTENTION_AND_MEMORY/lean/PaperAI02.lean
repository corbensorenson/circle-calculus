...
#check Circle.Applications.kvCacheWindow_sameSlotOverwrite_witness_of_not_contains
...
#check Circle.Applications.kvCacheWindowContains_iff_noSameSlotOverwrite_between_of_le
#check Circle.Applications.not_kvCacheWindowContains_iff_exists_sameSlotOverwrite_between_of_le
...
#check Circle.Applications.kvCacheWindow_retainedBatch_iff_noSameSlotOverwriteTrace_of_forall_le
#check Circle.Applications.kvCacheWindow_traceFreshBatchSlotMap_nodup
#check Circle.Applications.not_kvCacheAdapterRequestTracePass_of_stale_member
#check Circle.Applications.kvCacheAdapterRequestTracePass_iff_no_stale_member_of_nonFuture_nodup
#check Circle.Applications.not_kvCacheAdapterRequestTracePass_iff_exists_stale_member_of_nonFuture_nodup
...
#check Circle.Applications.hybridFamilyCoveredLagList_disjoint_uncoveredLagList
#check Circle.Applications.mem_hybridFamilyCoveredLagList_or_mem_hybridFamilyUncoveredLagList_of_pos_lt_context
#check Circle.Applications.hybridFamilyCoveredUncoveredLagList_length_add
...
#check Circle.Applications.hybridFamilyRawCandidateBudget_ge_context_sub_one_of_covers
#check Circle.Applications.hybridFamilyUniqueLagCandidateCount_ge_context_sub_one_of_covers
#check Circle.Applications.hybridFamilyCoversContext_iff_uniqueLagCandidateCount_eq_context_sub_one_of_candidate_range
#check Circle.Applications.hybridFamilyCoveredLagList_length_eq_uniqueLagCandidateCount_of_candidate_range
#check Circle.Applications.hybridFamilyUncoveredLagList_length_eq_context_sub_one_sub_uniqueLagCandidateCount_of_candidate_range
#check Circle.Applications.hybridFamilyLagCandidateList_candidate_range_of_window_lt_context_of_noWrapSeparated
#check Circle.Applications.hybridFamilyCoversContext_iff_uniqueLagCandidateCount_eq_context_sub_one_of_noWrapSeparated
#check Circle.Applications.coilStrideFamilyNoZeroResidues
#check Circle.Applications.mem_coilStrideFamilyLagResidueList_pos_of_noZeroResidues
#check Circle.Applications.hybridFamilyLagCandidateList_candidate_range_of_window_lt_context_of_noZeroResidues
#check Circle.Applications.hybridFamilyCoversContext_iff_uniqueLagCandidateCount_eq_context_sub_one_of_noZeroResidues
#check Circle.Applications.hybridFamilyUniqueLagCandidateCount_lt_context_sub_one_iff_exists_uncovered_lag_of_candidate_range
#check Circle.Applications.hybridFamilyUniqueLagCandidateCount_lt_context_sub_one_iff_exists_uncovered_lag_of_noWrapSeparated
#check Circle.Applications.hybridFamilyUniqueLagCandidateCount_lt_context_sub_one_iff_exists_uncovered_lag_of_noZeroResidues
#check Circle.Applications.hybridFamilyUniqueQueryCandidateCount_lt_context_sub_one_iff_exists_uncovered_lag_of_candidate_range_of_predecessor_injective
#check Circle.Applications.hybridFamilyUniqueQueryCandidateCount_lt_context_sub_one_iff_exists_uncovered_lag_of_noWrapSeparated
#check Circle.Applications.hybridFamilyUniqueQueryCandidateCount_lt_context_sub_one_iff_exists_uncovered_lag_of_noZeroResidues
