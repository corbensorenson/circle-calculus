...
| [1000000000000, 1000010000000) | `external_high_offset_confirmation` | `external_primesieve_count_server` | `presieve13` | `presieve13` | 1310720 | 1310720 | 8/8 -> 8/8 | 1.429 | noisy<br>effective stable<br>C n=45, robust/med=1.70, max/med=2.13<br>B n=45, robust/med=1.77, max/med=2.57<br>mode confirmed 5/3 | 1.000x | `aligned` |
