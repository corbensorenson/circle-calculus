...
Generated: `2026-06-21T23:44:24Z`
...
| [1500000000000, 1500010000000) | `external_high_offset_confirmation` | `external_primesieve_count_server` | `presieve17` | `presieve17` | 1310720 | 1310720 | 8/8 -> 8/8 | 0.025 | noisy<br>effective stable<br>C n=27, robust/med=1.73, max/med=5.30<br>B n=27, robust/med=1.40, max/med=1.66<br>mode confirmed 3/2 | 1.000x | `aligned` |
| [10000000000000, 10000010000000) | `external_high_offset_confirmation` | `external_primesieve_count_server` | `presieve13` | `presieve13` | 1310720 | 1310720 | 8/8 -> 8/8 | 0.030 | noisy<br>effective stable<br>C n=27, robust/med=2.21, max/med=3.02<br>B n=27, robust/med=1.35, max/med=1.48<br>mode confirmed 2/2 | 1.000x | `aligned` |
| [100000000000000, 100000010000000) | `external_high_offset_confirmation` | `external_primesieve_count_server` | `presieve13` | `presieve13` | 1310720 | 1310720 | 8/8 -> 8/8 | 0.032 | noisy<br>effective stable<br>C n=27, robust/med=1.90, max/med=2.67<br>B n=27, robust/med=1.47, max/med=1.48<br>mode confirmed 2/2 | 1.000x | `aligned` |
