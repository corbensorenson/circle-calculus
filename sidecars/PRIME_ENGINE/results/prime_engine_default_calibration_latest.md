...
| [1000000000000, 1000010000000) | `external_high_offset_quick` | `external_primesieve_count` | `segmented` | `presieve13` | 1310720 | 1310720 | 8/8 -> 8/8 | 5.230 | noisy<br>C n=13, max/med=3.81<br>B n=13, max/med=2.20<br>mode unconfirmed 1/2 | 1.015x | `within_tolerance` |
