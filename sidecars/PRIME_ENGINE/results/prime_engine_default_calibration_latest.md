...
| [1000000000000, 1000010000000) | `external_high_offset_confirmation` | `external_primesieve_count_server` | `presieve13` | `presieve13` | 1310720 | 1310720 | 8/8 -> 8/8 | 1.565 | noisy<br>effective stable<br>C n=45, robust/med=2.75, max/med=3.35<br>B n=45, robust/med=2.54, max/med=2.82<br>mode confirmed 3/2 | 1.000x | `aligned` |
