...
Generated: `2026-06-20T02:19:43Z`
...
- `primesieve` cold CLI: Circle faster on 3/3 rows by best time; median faster on 2/3 rows.
...
| --- | --- | --- | ---: | ---: | --- | --- |
| [0, 10000000) | `circle_prime_default_count`<br>mode: `prefix-pi` (threads: 1/8) | `external_primesieve_count` (threads: 8) | 1.067 | 1.146 | stable<br>C n=7, max/med=1.20<br>B n=7, max/med=1.10 | circle_faster |
| [0, 10000000) | `circle_prime_server_default_count`<br>mode: `prefix-pi` (threads: 1/8) | `external_primesieve_count` (threads: 8) | 31.182 | 26.621 | stable<br>C n=7, max/med=1.40<br>B n=7, max/med=1.10 | circle_faster |
| [0, 10000000) | `circle_prime_default_count`<br>mode: `prefix-pi` (threads: 1/8) | `external_primecount_pi_diff` (threads: 8) | 1.631 | 1.675 | stable<br>C n=7, max/med=1.20<br>B n=7, max/med=1.13 | circle_faster |
| [0, 10000000) | `circle_prime_server_default_count`<br>mode: `prefix-pi` (threads: 1/8) | `external_primecount_pi_diff` (threads: 8) | 47.670 | 38.923 | stable<br>C n=7, max/med=1.40<br>B n=7, max/med=1.13 | circle_faster |
| [0, 100000000) | `circle_prime_default_count`<br>mode: `prefix-pi` (threads: 1/8) | `external_primesieve_count` (threads: 8) | 1.463 | 1.539 | stable<br>C n=7, max/med=1.01<br>B n=7, max/med=1.27 | circle_faster |
| [0, 100000000) | `circle_prime_server_default_count`<br>mode: `prefix-pi` (threads: 1/8) | `external_primesieve_count` (threads: 8) | 11.137 | 10.247 | stable<br>C n=7, max/med=1.31<br>B n=7, max/med=1.27 | circle_faster |
| [0, 100000000) | `circle_prime_default_count`<br>mode: `prefix-pi` (threads: 1/8) | `external_primecount_pi_diff` (threads: 8) | 1.530 | 1.623 | stable<br>C n=7, max/med=1.01<br>B n=7, max/med=1.16 | circle_faster |
| [0, 100000000) | `circle_prime_server_default_count`<br>mode: `prefix-pi` (threads: 1/8) | `external_primecount_pi_diff` (threads: 8) | 11.646 | 10.806 | stable<br>C n=7, max/med=1.31<br>B n=7, max/med=1.16 | circle_faster |
| [1000000000000, 1000010000000) | `circle_prime_parallel_default_count_7t`<br>mode: `presieve17` (threads: 7/8) | `external_primesieve_count` (threads: 8) | 1.023 | 0.940 | stable<br>C n=7, max/med=1.06<br>B n=7, max/med=1.06 | baseline_faster |
| [1000000000000, 1000010000000) | `circle_prime_server_parallel_default_count_7t`<br>mode: `presieve17` (threads: 7/8) | `external_primesieve_count` (threads: 8) | 2.440 | 2.121 | stable<br>C n=7, max/med=1.47<br>B n=7, max/med=1.06 | circle_faster |
| [1000000000000, 1000010000000) | `circle_prime_parallel_default_count_7t`<br>mode: `presieve17` (threads: 7/8) | `external_primecount_pi_diff` (threads: 8) | 5.197 | 5.272 | stable<br>C n=7, max/med=1.06<br>B n=7, max/med=1.18 | circle_faster |
| [1000000000000, 1000010000000) | `circle_prime_server_parallel_default_count_7t`<br>mode: `presieve17` (threads: 7/8) | `external_primecount_pi_diff` (threads: 8) | 12.389 | 11.897 | stable<br>C n=7, max/med=1.47<br>B n=7, max/med=1.18 | circle_faster |
...
| --- | --- | --- | ---: | ---: | ---: | ---: | --- | --- |
| [1000000000000, 1000010000000) | `external_primesieve_count` | `presieve17` | 1441792 | 7/8 | 1/2 | 2/3 | 4.847 | `unconfirmed` |
...
| Range | Baseline | Circle Row | Segment | Threads | Best ms | Median ms | Best Speedup | Median Speedup | Samples | Verdict |
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | --- | --- |
| [0, 1000000000) | `external_primecount_pi_diff` | `circle_prime_default_count`<br>mode: `prefix-pi` | 262144 | 1/8 | 5.790 | 6.190 | 0.758 | 0.782 | noisy<br>C n=5, max/med=1.18<br>B n=5, max/med=2.30 | baseline_faster |
| [0, 1000000000) | `external_primesieve_count` | `circle_prime_default_count`<br>mode: `prefix-pi` | 262144 | 1/8 | 5.790 | 6.190 | 3.139 | 3.355 | stable<br>C n=5, max/med=1.18<br>B n=5, max/med=1.05 | circle_faster |
| [1000000000, 2000000000) | `external_primecount_pi_diff` | `circle_prime_parallel_default_count_2t`<br>mode: `prefix-pi` | 262144 | 2/8 | 9.474 | 10.280 | 0.913 | 1.091 | noisy<br>C n=5, max/med=1.08<br>B n=5, max/med=8.41 | circle_faster |
| [1000000000, 2000000000) | `external_primesieve_count` | `circle_prime_parallel_default_count_2t`<br>mode: `prefix-pi` | 262144 | 2/8 | 9.474 | 10.280 | 2.226 | 3.212 | stable<br>C n=5, max/med=1.08<br>B n=5, max/med=1.28 | circle_faster |

| Range | Baseline | Circle Row | Segment | Threads | Best ms | Median ms | Best Speedup | Median Speedup | Samples | Verdict |
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | --- | --- |
| [0, 1000000000) | `external_primecount_pi_diff` | `circle_prime_default_count`<br>mode: `prefix-pi` | 262144 | 1/8 | 5.790 | 6.190 | 0.758 | 0.782 | noisy<br>C n=5, max/med=1.18<br>B n=5, max/med=2.30 | baseline_faster |
| [0, 1000000000) | `external_primesieve_count` | `circle_prime_default_count`<br>mode: `prefix-pi` | 262144 | 1/8 | 5.790 | 6.190 | 3.139 | 3.355 | stable<br>C n=5, max/med=1.18<br>B n=5, max/med=1.05 | circle_faster |
| [1000000000, 2000000000) | `external_primecount_pi_diff` | `circle_prime_parallel_prefix_pi_count_2t`<br>mode: `prefix-pi` | 262144 | 2/8 | 9.643 | 9.771 | 0.897 | 1.148 | noisy<br>C n=5, max/med=1.13<br>B n=5, max/med=8.41 | circle_faster |
| [1000000000, 2000000000) | `external_primesieve_count` | `circle_prime_parallel_prefix_pi_count_2t`<br>mode: `prefix-pi` | 262144 | 2/8 | 9.643 | 9.771 | 2.187 | 3.380 | stable<br>C n=5, max/med=1.13<br>B n=5, max/med=1.28 | circle_faster |

Throughput segment candidate spread:

| Range | Baseline | Circle Row | Segment | Threads | Best ms | Median ms | Best Speedup | Median Speedup | Samples |
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| [0, 1000000000) | `external_primecount_pi_diff` | `circle_prime_default_count`<br>mode: `prefix-pi` | 262144 | 1/8 | 5.790 | 6.190 | 0.758 | 0.782 | noisy<br>C n=5, max/med=1.18<br>B n=5, max/med=2.30 |
| [0, 1000000000) | `external_primecount_pi_diff` | `circle_prime_prefix_pi_count`<br>mode: `prefix-pi` | 262144 | 1/8 | 6.415 | 6.932 | 0.684 | 0.699 | noisy<br>C n=5, max/med=1.08<br>B n=5, max/med=2.30 |
| [0, 1000000000) | `external_primecount_pi_diff` | `circle_prime_parallel_segmented_count_8t`<br>mode: `segmented` | 196608 | 8 | 41.932 | 45.191 | 0.105 | 0.107 | noisy<br>C n=5, max/med=1.21<br>B n=5, max/med=2.30 |
| [0, 1000000000) | `external_primecount_pi_diff` | `circle_prime_parallel_segmented_count_8t`<br>mode: `segmented` | 131072 | 8 | 39.897 | 45.620 | 0.110 | 0.106 | noisy<br>C n=5, max/med=1.07<br>B n=5, max/med=2.30 |
| [0, 1000000000) | `external_primecount_pi_diff` | `circle_prime_parallel_segmented_count_8t`<br>mode: `segmented` | 262144 | 8 | 42.214 | 48.233 | 0.104 | 0.100 | noisy<br>C n=5, max/med=1.05<br>B n=5, max/med=2.30 |
| [0, 1000000000) | `external_primesieve_count` | `circle_prime_default_count`<br>mode: `prefix-pi` | 262144 | 1/8 | 5.790 | 6.190 | 3.139 | 3.355 | stable<br>C n=5, max/med=1.18<br>B n=5, max/med=1.05 |
| [0, 1000000000) | `external_primesieve_count` | `circle_prime_prefix_pi_count`<br>mode: `prefix-pi` | 262144 | 1/8 | 6.415 | 6.932 | 2.833 | 2.996 | stable<br>C n=5, max/med=1.08<br>B n=5, max/med=1.05 |
| [0, 1000000000) | `external_primesieve_count` | `circle_prime_parallel_segmented_count_8t`<br>mode: `segmented` | 196608 | 8 | 41.932 | 45.191 | 0.433 | 0.460 | stable<br>C n=5, max/med=1.21<br>B n=5, max/med=1.05 |
| [0, 1000000000) | `external_primesieve_count` | `circle_prime_parallel_segmented_count_8t`<br>mode: `segmented` | 131072 | 8 | 39.897 | 45.620 | 0.456 | 0.455 | stable<br>C n=5, max/med=1.07<br>B n=5, max/med=1.05 |
| [0, 1000000000) | `external_primesieve_count` | `circle_prime_parallel_segmented_count_8t`<br>mode: `segmented` | 262144 | 8 | 42.214 | 48.233 | 0.431 | 0.431 | stable<br>C n=5, max/med=1.05<br>B n=5, max/med=1.05 |
| [1000000000, 2000000000) | `external_primecount_pi_diff` | `circle_prime_parallel_prefix_pi_count_2t`<br>mode: `prefix-pi` | 262144 | 2/8 | 9.643 | 9.771 | 0.897 | 1.148 | noisy<br>C n=5, max/med=1.13<br>B n=5, max/med=8.41 |
| [1000000000, 2000000000) | `external_primecount_pi_diff` | `circle_prime_parallel_default_count_2t`<br>mode: `prefix-pi` | 262144 | 2/8 | 9.474 | 10.280 | 0.913 | 1.091 | noisy<br>C n=5, max/med=1.08<br>B n=5, max/med=8.41 |
| [1000000000, 2000000000) | `external_primecount_pi_diff` | `circle_prime_parallel_segmented_count_8t`<br>mode: `segmented` | 262144 | 8 | 45.645 | 47.303 | 0.190 | 0.237 | noisy<br>C n=5, max/med=1.13<br>B n=5, max/med=8.41 |
| [1000000000, 2000000000) | `external_primecount_pi_diff` | `circle_prime_parallel_segmented_count_8t`<br>mode: `segmented` | 196608 | 8 | 49.571 | 53.806 | 0.175 | 0.209 | noisy<br>C n=5, max/med=1.54<br>B n=5, max/med=8.41 |
| [1000000000, 2000000000) | `external_primecount_pi_diff` | `circle_prime_parallel_segmented_count_8t`<br>mode: `segmented` | 131072 | 8 | 51.534 | 56.231 | 0.168 | 0.200 | noisy<br>C n=5, max/med=1.09<br>B n=5, max/med=8.41 |
| [1000000000, 2000000000) | `external_primesieve_count` | `circle_prime_parallel_prefix_pi_count_2t`<br>mode: `prefix-pi` | 262144 | 2/8 | 9.643 | 9.771 | 2.187 | 3.380 | stable<br>C n=5, max/med=1.13<br>B n=5, max/med=1.28 |
| [1000000000, 2000000000) | `external_primesieve_count` | `circle_prime_parallel_default_count_2t`<br>mode: `prefix-pi` | 262144 | 2/8 | 9.474 | 10.280 | 2.226 | 3.212 | stable<br>C n=5, max/med=1.08<br>B n=5, max/med=1.28 |
| [1000000000, 2000000000) | `external_primesieve_count` | `circle_prime_parallel_segmented_count_8t`<br>mode: `segmented` | 262144 | 8 | 45.645 | 47.303 | 0.462 | 0.698 | stable<br>C n=5, max/med=1.13<br>B n=5, max/med=1.28 |
| [1000000000, 2000000000) | `external_primesieve_count` | `circle_prime_parallel_segmented_count_8t`<br>mode: `segmented` | 196608 | 8 | 49.571 | 53.806 | 0.425 | 0.614 | noisy<br>C n=5, max/med=1.54<br>B n=5, max/med=1.28 |
| [1000000000, 2000000000) | `external_primesieve_count` | `circle_prime_parallel_segmented_count_8t`<br>mode: `segmented` | 131072 | 8 | 51.534 | 56.231 | 0.409 | 0.587 | stable<br>C n=5, max/med=1.09<br>B n=5, max/med=1.28 |
...
| Workload | Row | Segment | Best ms | Count |
| ---: | --- | ---: | ---: | ---: |
| 10000000 | `high_offset_segmented_range_count` | 4194304 | 5.686 | 361726 |
| 10000000 | `parallel_high_offset_segmented_range_count_8t` | 1507328 | 1.783 | 361726 |
| 10000000 | `parallel_high_offset_default_range_count_8t` | 1507328 | 2.054 | 361726 |
| 10000000 | `parallel_high_offset_balanced_segmented_range_count_8t` | 1507328 | 1.843 | 361726 |
| 10000000 | `high_offset_presieve13_range_count` | 1507328 | 6.696 | 361726 |
| 10000000 | `parallel_high_offset_presieve13_range_count_8t` | 1507328 | 2.250 | 361726 |
| 10000000 | `high_offset_presieve17_range_count` | 1507328 | 6.248 | 361726 |
| 10000000 | `parallel_high_offset_presieve17_range_count_8t` | 1507328 | 2.863 | 361726 |
| 10000000 | `high_offset_bitpacked_range_count` | 1507328 | 7.468 | 361726 |
| 10000000 | `high_offset_tracked_byte_range_count` | 1507328 | 16.614 | 361726 |
| 10000000 | `high_offset_wheel30_range_count` | 1507328 | 47.950 | 361726 |
| 10000000 | `high_offset_wheel30_mark_range_count` | 1507328 | 7.059 | 361726 |
| 10000000 | `parallel_high_offset_wheel30_mark_range_count_8t` | 1507328 | 3.793 | 361726 |
| 10000000 | `high_offset_hybrid_wheel30_mark_range_count` | 1507328 | 7.905 | 361726 |
| 10000000 | `parallel_high_offset_hybrid_wheel30_mark_range_count_8t` | 1507328 | 3.652 | 361726 |
| 100000 | `high_offset_u64_scalar_fallback_range_count` | 64 | 44.332 | 2139 |
| 100000 | `high_offset_u64_scalar_naive_control_count` | 0 | 44.129 | 2139 |
| 10000000 | `hot_cli_count_server_parallel_high_offset_default_range_count_8t` | 1507328 | 1.994 | 361726 |
| 10000000 | `hot_cli_count_server_parallel_high_offset_segmented_count_8t` | 1507328 | 2.012 | 361726 |
| 10000000 | `hot_cli_count_server_parallel_high_offset_presieve13_count_8t` | 1507328 | 1.909 | 361726 |
| 10000000 | `hot_cli_count_server_parallel_high_offset_presieve17_count_8t` | 1507328 | 2.029 | 361726 |
| 1000000 | `cold_process_segmented_range_count` | 262144 | 1.569 | 78498 |
| 10000000 | `cold_process_segmented_range_count` | 262144 | 2.684 | 664579 |
| 10000000 | `cold_process_parallel_segmented_range_count_8t` | 65536 | 2.167 | 664579 |
| 10000000 | `cold_cli_parallel_default_range_count_8t` | 65536 | 1.506 | 664579 |
| 100000000 | `cold_process_parallel_segmented_range_count_8t` | 196608 | 5.415 | 5761455 |
| 100000000 | `cold_cli_parallel_default_range_count_8t` | 196608 | 1.676 | 5761455 |
| 10000000 | `cold_process_parallel_high_offset_segmented_range_count_8t` | 1507328 | 4.261 | 361726 |
| 10000000 | `cold_cli_parallel_high_offset_default_range_count_8t` | 1507328 | 4.643 | 361726 |
...
| ---: | --- | ---: | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| 10000000 | `parallel_high_offset_segmented_range_count_8t` | 1.783 | `hot_cli_count_server_parallel_high_offset_presieve13_count_8t` | 1.909 | 1.07x | 0.41x | 4.643 | 2.60x | 2.860 | 4.261 | 2.39x |
...
| ---: | --- | ---: | --- | ---: | ---: | ---: | ---: |
| 10000000 | `hot_cli_count_server_parallel_high_offset_presieve13_count_8t` | 1.909 | `external_primecount_pi_diff` | 22.759 | 11.922 | 4.380 | 5.197 |
| 10000000 | `hot_cli_count_server_parallel_high_offset_presieve13_count_8t` | 1.909 | `external_primecount_pi_diff` | 22.759 | 11.922 | 1.837 | 12.389 |
| 10000000 | `hot_cli_count_server_parallel_high_offset_presieve13_count_8t` | 1.909 | `external_primesieve_count` | 4.482 | 2.348 | 4.380 | 1.023 |
| 10000000 | `hot_cli_count_server_parallel_high_offset_presieve13_count_8t` | 1.909 | `external_primesieve_count` | 4.482 | 2.348 | 1.837 | 2.440 |
