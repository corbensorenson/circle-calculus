...
def main() -> int:
    ...
    parser.add_argument(
        ...
        type=float,
        help=(
            "Fail unless every compared row has candidate median_speedup at or "
            "above this threshold. Use with --names/--baselines/--starts for "
            "targeted serious-control win gates."
        ),
    )
    parser.add_argument(
