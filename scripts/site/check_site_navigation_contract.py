...
REQUIRED_NAV_HREFS = {
    ...
    "chapters/applications/erdos_bridges.qmd",
...
PAGE_CONTRACTS = {
    ...
    "reader_path.qmd": [
        ...
        ("classical bridge page", ["Classical Bridges"]),
    ...
    "chapters/applications/erdos_bridges.qmd": [
        ("standard bridge purpose", ["established Erdos-style combinatorics lanes"]),
        ("standard parity language", ["standard-math parity"]),
        ("Circle-native value language", ["Circle-native value"]),
        ("proof boundary", ["not new proofs", "not progress claims"]),
        ("showcase links", ["SHOW-001", "SHOW-005"]),
    ],
    "chapters/foundations/index.qmd": [
