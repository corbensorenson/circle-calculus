...
CIRCLE_PRIME_HIGH_OFFSET_COUNT_BINARY_SOCKET_CLIENT_ROUNDS ?= 41
CIRCLE_PRIME_HIGH_OFFSET_COUNT_BINARY_SOCKET_CLIENT_BATCH_SIZE ?= 1
CIRCLE_PRIME_HIGH_OFFSET_COUNT_BINARY_SOCKET_CLIENT_WARMUP_ROUNDS ?= 5
CIRCLE_PRIME_HIGH_OFFSET_COUNT_BINARY_SOCKET_CLIENT_OUTPUT ?= sidecars/PRIME_ENGINE/results/prime_engine_high_offset_count_binary_socket_client_latest.csv
CIRCLE_PRIME_HIGH_OFFSET_COUNT_BINARY_SOCKET_CLIENT_SAMPLES ?= sidecars/PRIME_ENGINE/results/prime_engine_high_offset_count_binary_socket_client_samples_latest.csv
CIRCLE_PRIME_HIGH_OFFSET_COUNT_BINARY_SOCKET_CLIENT_METADATA ?= sidecars/PRIME_ENGINE/results/prime_engine_high_offset_count_binary_socket_client_latest.json
CIRCLE_PRIME_HIGH_OFFSET_COUNT_BINARY_SOCKET_CLIENT_MIN_MEDIAN_SPEEDUP ?= 1.0
CIRCLE_PRIME_HIGH_OFFSET_COUNT_BINARY_SOCKET_CLIENT_MIN_BEST_SPEEDUP ?= 1.0
...
CIRCLE_PRIME_COMPETITIVE_SMOKE_BATCH_SIZE ?= 40
...
CIRCLE_PRIME_FUZZY_HYBRID_ANY_MIN_RUST_VS_CIRCLE ?= 0.55
CIRCLE_PRIME_FUZZY_HYBRID_ANY_MIN_RUST_VS_PRIMESIEVE_GENERATE ?= 1.5
...
CIRCLE_PRIME_BIGINT_BENCH_ROUNDS ?= 15
...
CIRCLE_PRIME_BIGINT_FUZZY_PROFILE ?= bpsw
...
CIRCLE_PRIME_BIGINT_NEXT_FUZZY_CONFIRM_BENCH_ROUNDS ?= 15
CIRCLE_PRIME_BIGINT_NEXT_FUZZY_CONFIRM_FUZZY_PROFILE ?= bpsw
CIRCLE_PRIME_BIGINT_NEXT_FUZZY_CONFIRM_MIN_BPSW_NEXT_VS_SYMPY ?= $(CIRCLE_PRIME_BIGINT_MIN_BPSW_NEXT_VS_SYMPY)
CIRCLE_PRIME_BIGINT_NEXT_FUZZY_CONFIRM_MIN_FUZZY_ANY_VS_SYMPY ?= 1.0
...
CIRCLE_PRIME_EXTERNAL_NEXT_SHIFTED_STARTS ?= 90,1000000,4294967000,1000000000000
CIRCLE_PRIME_EXTERNAL_NEXT_SHIFTED_ROUNDS ?= 5
CIRCLE_PRIME_EXTERNAL_NEXT_SHIFTED_BATCH_SIZE ?= 64
CIRCLE_PRIME_EXTERNAL_NEXT_SHIFTED_BATCH_SHIFT ?= 4096
CIRCLE_PRIME_EXTERNAL_NEXT_SHIFTED_WARMUP_ROUNDS ?= 1
CIRCLE_PRIME_EXTERNAL_NEXT_SHIFTED_COMPARE_STARTS ?= $(CIRCLE_PRIME_EXTERNAL_NEXT_SHIFTED_STARTS)
CIRCLE_PRIME_EXTERNAL_NEXT_SHIFTED_BASELINES ?= external_primesieve_generate_shifted_next_server,external_primesieve_iterator_shifted_next_server
CIRCLE_PRIME_EXTERNAL_NEXT_SHIFTED_MIN_MEDIAN_SPEEDUP ?= 1.0
CIRCLE_PRIME_EXTERNAL_NEXT_SHIFTED_NOISY_MEDIAN_BYPASS ?= 1.5
CIRCLE_PRIME_EXTERNAL_NEXT_SHIFTED_REQUIRE_STABLE_SAMPLES ?= 1
CIRCLE_PRIME_EXTERNAL_NEXT_SHIFTED_OUTPUT ?= sidecars/PRIME_ENGINE/results/prime_engine_external_next_shifted_latest.csv
CIRCLE_PRIME_EXTERNAL_NEXT_SHIFTED_SAMPLES ?= sidecars/PRIME_ENGINE/results/prime_engine_external_next_shifted_samples_latest.csv
CIRCLE_PRIME_EXTERNAL_NEXT_SHIFTED_METADATA ?= sidecars/PRIME_ENGINE/results/prime_engine_external_next_shifted_latest.json
...
CIRCLE_PRIME_EXTERNAL_NEXT_SHIFTED_COMPARE_ARGS := --baseline $(CIRCLE_PRIME_EXTERNAL_NEXT_SHIFTED_OUTPUT) --starts $(CIRCLE_PRIME_EXTERNAL_NEXT_SHIFTED_COMPARE_STARTS) --min-median-speedup-ratio 0.0 --min-best-speedup-ratio 0.0 --names circle_prime_server_shifted_next_prime --baselines $(CIRCLE_PRIME_EXTERNAL_NEXT_SHIFTED_BASELINES) --require-each-median-speedup-at-least $(CIRCLE_PRIME_EXTERNAL_NEXT_SHIFTED_MIN_MEDIAN_SPEEDUP)
...
ifneq ($(strip $(CIRCLE_PRIME_EXTERNAL_NEXT_SHIFTED_REQUIRE_STABLE_SAMPLES)),)
CIRCLE_PRIME_EXTERNAL_NEXT_SHIFTED_COMPARE_ARGS += --require-stable-samples
endif
ifneq ($(strip $(CIRCLE_PRIME_EXTERNAL_NEXT_SHIFTED_NOISY_MEDIAN_BYPASS)),)
CIRCLE_PRIME_EXTERNAL_NEXT_SHIFTED_COMPARE_ARGS += --allow-noisy-when-median-speedup-at-least $(CIRCLE_PRIME_EXTERNAL_NEXT_SHIFTED_NOISY_MEDIAN_BYPASS)
endif
...
prime-engine-competitive-status:
	...
	$(MAKE) prime-engine-high-offset-count-binary-socket-client-check
	...
	$(MAKE) prime-engine-external-next-shifted
...
prime-engine-high-offset-count-binary-socket-client:
	python scripts/benchmark_prime_external_controls.py --ranges $(CIRCLE_PRIME_HIGH_OFFSET_COMPARE_RANGES) --rounds $(CIRCLE_PRIME_HIGH_OFFSET_COUNT_BINARY_SOCKET_CLIENT_ROUNDS) --batch-size $(CIRCLE_PRIME_HIGH_OFFSET_COUNT_BINARY_SOCKET_CLIENT_BATCH_SIZE) --warmup-rounds $(CIRCLE_PRIME_HIGH_OFFSET_COUNT_BINARY_SOCKET_CLIENT_WARMUP_ROUNDS) --interleaved --include-circle-server --circle-server-only --include-circle-count-binary-socket-client --external-baselines external_primesieve_count --require-tool primesieve --circle-threads $(CIRCLE_PRIME_THREADS) --external-threads $(EXTERNAL_PRIME_THREADS) --circle-variant default:0:$(CIRCLE_PRIME_THREADS) --output $(CIRCLE_PRIME_HIGH_OFFSET_COUNT_BINARY_SOCKET_CLIENT_OUTPUT) --sample-output $(CIRCLE_PRIME_HIGH_OFFSET_COUNT_BINARY_SOCKET_CLIENT_SAMPLES) --metadata-output $(CIRCLE_PRIME_HIGH_OFFSET_COUNT_BINARY_SOCKET_CLIENT_METADATA)
	$(MAKE) prime-engine-high-offset-count-binary-socket-client-check

prime-engine-high-offset-count-binary-socket-client-check:
	cargo build --release -p circle-prime --bin circle-prime
	cargo build --release -p circle-prime --bin circle-prime-count
	python scripts/check_prime_benchmark_provenance.py --metadata $(CIRCLE_PRIME_HIGH_OFFSET_COUNT_BINARY_SOCKET_CLIENT_METADATA) $(CIRCLE_PRIME_REQUIRE_PRIMESIEVE_VERSION) --max-circle-prime-count-size-bytes $(CIRCLE_PRIME_HIGH_OFFSET_COUNT_BINARY_MAX_SIZE_BYTES) --expect batch_request_profile=identical --expect batch_shift=0 --expect batch_size=$(CIRCLE_PRIME_HIGH_OFFSET_COUNT_BINARY_SOCKET_CLIENT_BATCH_SIZE) --expect rounds=$(CIRCLE_PRIME_HIGH_OFFSET_COUNT_BINARY_SOCKET_CLIENT_ROUNDS) --expect warmup_rounds=$(CIRCLE_PRIME_HIGH_OFFSET_COUNT_BINARY_SOCKET_CLIENT_WARMUP_ROUNDS) --expect interleaved=true --expect include_circle_count_binary=false --expect include_circle_count_binary_server=false --expect include_circle_count_binary_socket_client=true --expect include_circle_server=true --expect circle_server_only=true --expect include_primesieve_count_server=false --expect include_primecount_pi_server=false --expect-ranges $(CIRCLE_PRIME_HIGH_OFFSET_COMPARE_RANGES)
	python scripts/compare_prime_external_controls.py $(CIRCLE_PRIME_HIGH_OFFSET_COUNT_BINARY_SOCKET_CLIENT_OUTPUT) --baseline $(CIRCLE_PRIME_HIGH_OFFSET_COUNT_BINARY_SOCKET_CLIENT_OUTPUT) --names circle_prime_count_binary_socket_client_default_count --baselines external_primesieve_count --ranges $(CIRCLE_PRIME_HIGH_OFFSET_COMPARE_RANGES) --min-median-speedup-ratio 0.0 --min-best-speedup-ratio 0.0 --require-each-median-speedup-at-least $(CIRCLE_PRIME_HIGH_OFFSET_COUNT_BINARY_SOCKET_CLIENT_MIN_MEDIAN_SPEEDUP) --require-each-best-speedup-at-least $(CIRCLE_PRIME_HIGH_OFFSET_COUNT_BINARY_SOCKET_CLIENT_MIN_BEST_SPEEDUP)
...
prime-engine-external-next-shifted:
	python scripts/benchmark_prime_external_next_shifted.py --starts $(CIRCLE_PRIME_EXTERNAL_NEXT_SHIFTED_STARTS) --rounds $(CIRCLE_PRIME_EXTERNAL_NEXT_SHIFTED_ROUNDS) --batch-size $(CIRCLE_PRIME_EXTERNAL_NEXT_SHIFTED_BATCH_SIZE) --batch-shift $(CIRCLE_PRIME_EXTERNAL_NEXT_SHIFTED_BATCH_SHIFT) --warmup-rounds $(CIRCLE_PRIME_EXTERNAL_NEXT_SHIFTED_WARMUP_ROUNDS) --include-primesieve-library-server --include-primesieve-iterator-server --primesieve-library-max-start $(CIRCLE_PRIME_EXTERNAL_NEXT_PRIMESIEVE_LIBRARY_MAX_START) --require-tool primesieve-library --require-tool primesieve-iterator-library --output $(CIRCLE_PRIME_EXTERNAL_NEXT_SHIFTED_OUTPUT) --sample-output $(CIRCLE_PRIME_EXTERNAL_NEXT_SHIFTED_SAMPLES) --metadata-output $(CIRCLE_PRIME_EXTERNAL_NEXT_SHIFTED_METADATA)
	$(MAKE) prime-engine-external-next-shifted-check

prime-engine-external-next-shifted-check:
	cargo build --release -p circle-prime --bin circle-prime
	python scripts/check_prime_benchmark_provenance.py --metadata $(CIRCLE_PRIME_EXTERNAL_NEXT_SHIFTED_METADATA) $(CIRCLE_PRIME_REQUIRE_PRIMESIEVE_VERSION) --expect server_only=true --expect batch_request_profile=shifted --expect batch_shift=$(CIRCLE_PRIME_EXTERNAL_NEXT_SHIFTED_BATCH_SHIFT) --expect batch_size=$(CIRCLE_PRIME_EXTERNAL_NEXT_SHIFTED_BATCH_SIZE) --expect rounds=$(CIRCLE_PRIME_EXTERNAL_NEXT_SHIFTED_ROUNDS) --expect warmup_rounds=$(CIRCLE_PRIME_EXTERNAL_NEXT_SHIFTED_WARMUP_ROUNDS) --expect include_circle_server=true --expect include_primesieve_library_server=true --expect include_primesieve_iterator_server=true --expect include_primecount_library_server=false --expect-starts $(CIRCLE_PRIME_EXTERNAL_NEXT_SHIFTED_STARTS)
	python scripts/compare_prime_external_next.py $(CIRCLE_PRIME_EXTERNAL_NEXT_SHIFTED_OUTPUT) $(CIRCLE_PRIME_EXTERNAL_NEXT_SHIFTED_COMPARE_ARGS)
