    ...
    *,
    ...
    return ExactDiscreteRoPECertificate(
        ...
        assumptions=(
            ...
            "Lean theorem AIRA-T0036 proves all-channel bank collision is equivalent to divisibility by the period-bank LCM, making the bank collision count total for the integer-period model. AIRA-T0179 proves that positive declared periods give the positive LCM required by the witness/count theorems. AIRA-T0180 proves the end-to-end exact pass/fail contract: no unequal in-context all-channel collision iff the LCM reaches the context. AIRA-T0048 and AIRA-T0049 prove the fail side: starts at the LCM gap collide, and a positive LCM below context yields an explicit unequal collision witness.",
