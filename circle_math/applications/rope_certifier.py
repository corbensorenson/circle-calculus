...
ROPE_STANDARD_CHANNEL0_INTERVAL_SEED_NAME = "standard_rope_channel0_interval_context_163840"
...
def certify_standard_channel0_interval_seed() -> IntervalBackedTurnRatioCertificate:
    ...
    turn ratio ``1 / (2π)`` over the context containing gaps 1 through 163839.
    ...
    margin and extends the compiled seed through context 163840.
    """
    ...
    return IntervalBackedTurnRatioCertificate(
        ...
        explanation=(
            ...
            "has finite nearest-integer margin 1/328459 for gaps 1 through 163839. "
            "The generated D18 compressed certificate uses the 20-decimal enclosure "
            "10^20*gap/628318530717958647694 <= gap/(2*pi) <= "
            "10^20*gap/628318530717958647692, split across computed integer "
            "cells 0 through 26075. Lean also proves that the earlier 1/1024 "
            ...
            "margin to the 160k context; the adjacent larger "
            "margin 1/328458 is impossible once gap 103993 is in scope. "
            "D16, D17, and D18 package their corresponding brackets and add "
        ...
        claim_boundary=(
            ...
            "RoPE channel-0 turn ratio over context 163840, plus conditional "
...
def certify_rope_positions(config: RoPEConfig) -> RoPEPositionCertificate:
    ...
    proof_layers = (
        ...
        RoPEProofLayerReport(
            ...
            explanation=(
                "The bracketed 160k genuine standard-RoPE interval seed certifies channel 0 "
                "with turn ratio 1/(2*pi), margin 1/328459, and context 163840; "
                "the same theorem trail refutes every advertised margin at or above "
                "1/328458 for that channel and context, and D18 one-separating-channel bank bridges "
