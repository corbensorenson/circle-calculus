    ...
    *,
    ...
    return StandardRoPEIntervalPlan(
        ...
        explanation=(
            ...
            "plans and the margin-1/104219 context-16384 plan have now "
...
def certify_standard_channel0_interval_seed() -> IntervalBackedTurnRatioCertificate:
    ...
    1/104219 to context 8192, and D14 extends it to context 16384.
    """
    ...
    return IntervalBackedTurnRatioCertificate(
        ...
        explanation=(
            ...
            "has finite nearest-integer margin 1/104219 for gaps 1 through 16383. "
            ...
            "cells 0 through 2607. Lean also proves that the earlier 1/1024 "
        ...
        claim_boundary=(
            ...
            "RoPE channel-0 turn ratio over context 16384, plus conditional "
...
def certify_rope_positions(config: RoPEConfig) -> RoPEPositionCertificate:
    ...
    proof_layers = (
        ...
        RoPEProofLayerReport(
            ...
            explanation=(
                "The bracketed 16k genuine standard-RoPE interval seed certifies channel 0 "
                "with turn ratio 1/(2*pi), margin 1/104219, and context 16384; "
                "the same theorem trail refutes every advertised margin at or above "
                "1/104218 for that channel, and D14 one-separating-channel bank bridges "
